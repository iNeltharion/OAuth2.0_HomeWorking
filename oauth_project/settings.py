...
SECRET_KEY = 'django-insecure-^_tl7kx702amb^@5g_=@5swd0pu%@wsy4q6wn5b@-z_qqp4o@j'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'social.django.context_processors.backends',
...
SOCIAL_AUTH_VK_OAUTH2_KEY = '52651122'
SOCIAL_AUTH_VK_OAUTH2_SECRET = 'y683tmIYz5MlX42LedEi'
